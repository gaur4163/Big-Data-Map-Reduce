...
public class Job6Driver extends Configured implements Tool {

	private static Logger THE_LOGGER = Logger.getLogger(Job6Driver.class);

	@Override
	public int run(String[] args) throws Exception {
		Job job = new Job(getConf());
		job.setJarByClass(Job6Driver.class);
		job.setJobName("Job1");
	...
	public static void main(String[] args) throws Exception {
		...
		int returnStatus = ToolRunner.run(new Job6Driver(), args);
